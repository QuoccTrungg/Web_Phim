...
<div class="row container" id="wrapper">
            <div class="halim-panel-filter">
               <div class="panel-heading">
                  <div class="row">
                     <div class="col-xs-6">
                        <div class="yoast_breadcrumb hidden-xs"><span><span><a href="">{{$cate_slug->title}}</a> » <span class="breadcrumb_last" aria-current="page">2024</span></span></span></div>
                     </div>
                  </div>
               </div>
                           ...
                           <a class="halim-thumb" href="{{route('movie',$mov->slug)}}">
                              ...
                              <span class="status">
                                 @if($mov->resolution==0) HD
                                    ...
                                    @elseif($mov->resolution==4) FHD
                                    @else Trailer
                                    @endif
                              </span><span class="episode"><i class="fa fa-play" aria-hidden="true"></i>
                                 @if($mov->thuocphim==1) {{$mov->episode_count}} / {{$mov->sotap}} |
                                 @endif
                                 @if($mov->phude) Thuyết minh 
