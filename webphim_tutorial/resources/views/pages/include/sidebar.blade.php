 ...
 <aside id="sidebar" class="col-xs-12 col-sm-12 col-md-4">
                           ...
                           <div class="item post-37176">
                              <a href="{{route('movie',$hot_sidebar->slug)}}" title="{{$hot_sidebar->title}}">
                                 <div class="item-link">
                                    ...
                                    @elseif($hot_sidebar->resolution==4) FHD
                                    @else Trailer 
                                    @endif
                                    </span>
                                 </div>
                              ...
                              <div class="year" style="color: #9d9d9d;">{{$hot_sidebar->year}}</div>
            ...
            <aside id="sidebar" class="col-xs-12 col-sm-12 col-md-4" float="right">
               <div id="halim_tab_popular_videos-widget-7" class="widget halim_tab_popular_videos-widget">
                  <div class="section-bar clearfix">
                     <div class="section-title">
                        <span>Top Views</span>
