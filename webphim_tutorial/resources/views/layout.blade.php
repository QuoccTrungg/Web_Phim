...
<html lang="vi">
   ...
   <body class="home blog halimthemes halimmovies" data-masonry="">
               ...
               <div class="col-md-5 col-sm-6 halim-search-form hidden-xs">
                  <div class="header-nav">
                     <div class="col-xs-12">
                        ...
                        <ul class="list-group" id="result"  styde="display: none">
      ...
      <div id="fb-root"></div>
      <script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v19.0" nonce="iMFcuhA3"></script>
               ...
               if(search != ''){
                  ...
                  $.getJSON('/json_file/movies.json', function(data){
                     $.each(data,function(key,value){
                        ...
                        $('#result').append('<li class="list-group-item link-class" style ="cursor:pointer"><img height="40" width="40" class="img-thumbnail" src="/uploads/movie/'+value.image+'">'+value.title+'</li>');
      ...
      <script type="text/javascript">
        ...
        $('.filter-sidebar').click(function(){
            ...
            if( href == '#ngay') var value = 0;
            else if (href == '#tuan') var value = 1;
            else var value = 2;
            $.ajax({
                headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
